        ...
        try:
            if sender:
                try:
                    ...
                    if photos:
                        await client.send_file(entity=order_group_id, file=photos[0], caption=caption, parse_mode='html', link_preview=False, buttons=keyboard)
                    else:
                        await client.send_message(entity=order_group_id, message=caption, parse_mode='html', link_preview=False, buttons=keyboard)
                except:
                    await client.send_message(entity=order_group_id, message=caption, parse_mode='html', link_preview=False, buttons=keyboard)
            else:
                await client.send_message(entity=order_group_id, message=caption, parse_mode='html', link_preview=False, buttons=keyboard)
